  ...
  return (
    <>
      ...
      <group {...props} dispose={null}>
        ...
        <ambientLight intensity={0.1} color="#fe00fe" />
        <AccumulativeShadows
          frames={100}
          alphaTest={0.9}
          scale={30}
